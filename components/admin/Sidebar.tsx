      ...
      <div>
        <div className="flex flex-row items-center gap-2 border-b border-dashed border-[#25388C]/20 pb-10 max-md:justify-center">
          <Image
            ...
            width={37}
          />
          <h1 className="text-2xl font-semibold text-[#25388C] max-md:hidden">BookWise</h1>
        </div>
          ...
          {adminSideBarLinks.map((link) => {
            ...
            return (
              <Link href={link.route} key={link.route}>
                <div
                  className={cn(
                    "flex flex-row items-center w-full gap-2 rounded-lg px-5 py-3.5 max-md:justify-center hover:bg-[#25388C]/10 transition-all duration-300",
